...
fds.addState("R",-1,11,1210) #Init the state grid for reserves (You need to have negative values to keep all possible moves on grid)

fds.addControl("Q",-1,1,210)  #Control grid for quantity charged (negative) or discharged (positive)
